...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___frontmatter___group'
  ...
  | 'childMarkdownRemark___frontmatter___group'
...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___author___introduction'
...
export type BioQueryQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'introduction'>> }> }> };
...
export type BlogListQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }>, markdownRemark?: Maybe<(
